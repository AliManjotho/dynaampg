...
if __name__ == "__main__":
    ...
    LOAD_MODEL = os.path.join(SAVED_MODELS_DIR, 'baseline_classifier_iscx_vpn_9.pth')
    batch_size = 32
    hidden_size = 128
    ...
    title = "Precision-Recall Curve (No-Margins) - ISCX-VPN"
    file_name = "fig-pr-curves-iscx-vpn(nomargin).png"
